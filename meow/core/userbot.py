...
class userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("anime_societyy")
                await self.one.join_chat("nobi_bota")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("anime_societyy")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("anime_societyy")
                await self.one.join_chat("nobi_bots")
            except:
                pass
            assistants.append(4)
